        ...
        init: function () {
            ...
            var treeDataSource4 = new DataSourceTree({
                data: [
                    ...
                    { name: '<i class="fa fa-preprocess yellow"></i> Member <div class="tree-actions"><i class="fa fa-plus green"></i><i class="fa fa-trash-o danger"></i><i class="fa fa-rotate-right blizzard"></i></div>', type: 'item', additionalParameters: { id: 'I11' } },
            ...
            var treeDataSource5 = new DataSourceTree({
                data: [
                    ...
                    { name: '<i class="fa fa-preprocess"></i> Member <div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-rotate-right"></i></div><div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-rotate-right"></i></div>', type: 'item', additionalParameters: { id: 'I11' } },
            ...
            var treeDataSource6 = new DataSourceTree({
                data: [
                    ...
                    { name: '<i class="fa fa-preprocess"></i> Member <div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div><div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'item', additionalParameters: { id: 'I11' } },
