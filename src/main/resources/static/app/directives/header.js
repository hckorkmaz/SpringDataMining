    ...
    .directive('refreshPage', [
        ...
        function ($rootScope, $state, $stateParams) {
            return {
                ...
                link: function (scope, el, attr) {
                    el.on('click', function () {
                        var activeId = $('.tab-pane.page-tab-pane.active').attr("id");
                        if (activeId == "pageTabsDashboard") {
                            var iframe = $("#iframe-page-content-pageTabs");
                        } else {
                            var iframe = $("#iframe-page-content-" + activeId);
                        }
